        ...
        <header className="bg-white shadow-md">
            <div className="container mx-auto flex justify-between items-center p-4">
                ...
                <nav className="hidden md:flex space-x-6">
                    ...
                    <Link to="/faq" className="text-gray-700 hover:text-blue-600">FAQ</Link> {/* Lien FAQ */}
                    {isLoggedIn ? (
                        <>
            ...
            {isMenuOpen && (
                <div className="md:hidden bg-white shadow-md border-t px-4 py-2">
                    <ul className="flex flex-col space-y-2">
                        ...
                        {isLoggedIn ? (
                            <>
                                <li><Link to="/settings" className="text-gray-700 hover:text-blue-600">
                                    Settings
                                </Link></li>
                                <li>
                                    <button
                            ...
                            <li><Link to="/login" className="text-gray-700 hover:text-blue-600">Login / Sign Up</Link></li>
                        )}
                    </ul>
                </div>
            )}
